...
from moz_sql_parser.keywords import AND, AS, ASC, BETWEEN, CASE, COLLATE_NOCASE, CROSS_JOIN, DESC, ELSE, END, FROM, \
    ...
    THEN, UNION, UNION_ALL, USING, WHEN, WHERE, binary_ops, unary_ops, WITH, durations, INNER_JOIN_FETCH, OUTER_JOIN_FETCH, LEFT_JOIN_FETCH
...
join = (
    (CROSS_JOIN | INNER_JOIN_FETCH | OUTER_JOIN_FETCH | LEFT_JOIN_FETCH | FULL_JOIN | FULL_OUTER_JOIN | INNER_JOIN | JOIN | LEFT_JOIN | LEFT_OUTER_JOIN | RIGHT_JOIN | RIGHT_OUTER_JOIN)("op") +
